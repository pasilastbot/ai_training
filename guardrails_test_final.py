...
def run_guardrails(user_query):
    ...
    guardrails_schema = {
        ...
        "properties": {
            ...
            "out_of_scope": {
                "type": "boolean",
                "description": "Whether the query is out of scope for IT-services or Siili"
            },
            "competitor_alert": {
                "type": "boolean",
                "description": "Whether the query mentions a competitor company"
            },
            "alert": {
                "type": "object",
                "properties": {
