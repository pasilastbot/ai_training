    ...
    try:
        ...
        if args.output:
            ...
            with open(args.output, 'w', encoding='utf-8') as file:
                ...
                print(f"JSON content has been saved to {args.output}")
        else:
        ...
        if args.output:
            with open(args.output, 'w', encoding='utf-8') as file:
                json.dump(fallback_response, file, indent=2)
                print(f"Fallback JSON content has been saved to {args.output}")
        else:
